(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["add-card-add-card-module"], {
    ...
    /***/
    function Xzxl(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function j4hj(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var AddCardPage = /*#__PURE__*/function () {
        function AddCardPage(formBuilder, common, api, router) {
        ...
        _createClass(AddCardPage, [{
          ...
          key: "onAddCardSubmit",
          value: function onAddCardSubmit() {
            var _this = this;
            ...
            if (!this.addCardForm.valid) {
              ...
              var dict = this.addCardForm.value;
              dict['userId'] = this.userId;
              this.api.post('addCardInfo', dict, '').subscribe(function (result) {
                _this.submitcardAttempt = false;
                ...
                if (res.status == 422) {
                  ...
                  _this.common.presentToast('Card added Successfully!.', 'success');
                }
              }, function (error) {
                console.log(error);
              });
    ...
    /***/
    function jvsA(module, __webpack_exports__, __webpack_require__) {
      "use strict";
