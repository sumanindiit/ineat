            ...
            yield this.slides.getActiveIndex().then((index) => {
                ...
                switch (index) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        const getusernameValue = document.querySelector('input[name="username"]').value;
                        const getpasswordValue = document.querySelector('input[name="password"]').value;
                            ...
                            this.api.post('checkUserExists', { email: getusernameValue, password: getpasswordValue }, '')
                                ...
                                if (res.status === 422 || res.status === '422') {
                                    ...
                                    if (res.exists == 0 || res.exists == '0') {
                                        ...
                                        var userId = this.api.encryptData(res.userId, _config__WEBPACK_IMPORTED_MODULE_6__["config"].ENC_SALT);
                    ...
                    case 5:
                        ...
                        if (this.errors.indexOf(this.deliveryName) >= 0
                            ...
                            if (this.billingAddressValue == 1) {
                                if (this.errors.indexOf(this.billingName) >= 0
                    ...
                    case 7:
                        ...
                        if (this.errors.indexOf(this.cardNumber) > 0
